 ...
 *     @OA\Property(property="location", type="string", example="Quadra 1"),
 *     @OA\Property(property="lesson_period", type="integer", example=3),
 *     @OA\Property(property="start_time", type="string", format="datetime", example="2024-12-25T14:00:00.000000Z"),
 *     @OA\Property(property="end_time", type="string", format="datetime", example="2024-12-25T15:00:00.000000Z"),
 *     @OA\Property(property="booking_type", type="string", enum={"regular","friendly_match"}, example="regular"),
 ...
 *     @OA\Property(property="start_date", type="string", format="datetime", example="2024-12-01T00:00:00.000000Z"),
 *     @OA\Property(property="end_date", type="string", format="datetime", example="2024-12-15T23:59:59.000000Z"),
